...
if ($_SESSION['rol']=="Administrador") {
	...
	<div class="table-container" align="right">
		<a class="button is-link is-rounded is-small" href="index.php?vista=user_search"><i class="fa-solid fa-magnifying-glass"></i></a>
		<a class="button is-link is-rounded is-small" href="index.php?vista=user_new"><i class="fa-solid fa-user-plus"></i></a>
		<hr>
		...
		foreach($datos as $rows){
			$tabla.='
				<tr class="has-text-centered" >
                    ...
                    <td>
                        <a href="index.php?vista=user_update&user_id_up='.$rows['usuario_id'].'" class="button is-link is-rounded is-small"><i class="fa-solid fa-pen-to-square"></i></a>
                    </td>
                    <td>
                        <a href="'.$url.$pagina.'&user_id_del='.$rows['usuario_id'].'" class="button is-danger is-rounded is-small"><i class="fa-solid fa-trash"></i></a>
                    </td>
                </tr>
            ';
            $contador++;
